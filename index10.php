            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index10.php">    <i class="fa fa-angle-right"></i><em>   Day 10: The Fog Cutter          </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/Fog Cutter.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 10: The Fog Cutter (30<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                ...
                <div class="container">
                    <div class="one-half-responsive">
                        ...
                        <p>
                            This was refreshing to me. I enjoyed the greener flavor of this one.
                        </p>    
                    </div>
