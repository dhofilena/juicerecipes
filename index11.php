            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index11.php">    <i class="fa fa-angle-right"></i><em>   Day 11: Fresh Start          </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/Fresh Start.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 11: Fresh Start (28<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                        This is the recipe that we started with. You may or may not like the celery flavor, but as your taste buds change, so will your attitude towards celery!
                    </p>
                </div>
                ...
                <div class="container">
                    <div class="one-half-responsive">
                        ...
                        <p>
                            ...
                            <br><br>Don't think that just because it's said to be a "beginner juice" means it's not as good for you, this juice is great for you!
                        </p>    
                    </div>
