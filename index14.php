            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index14.php">    <i class="fa fa-angle-right"></i><em>   Day 14: Apple Crisp          </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 14: Apple Crisp (32<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
