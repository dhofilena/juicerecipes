            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index15.php">    <i class="fa fa-angle-right"></i><em>   Day 15: Can't Beet it          </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/Can't Beet it.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 15: Can't Beet it (32<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                        This tastes excellent. The beets and celery are great for the heart. I have always like beets anyway. I also like that there's a cucumber in there. Love it!!!
                    </p>
                </div>
                ...
                <div class="container">
                    <div class="one-half-responsive">
                        ...
                        <p>
                            This was my first serious juice. It tastes sweet and I couldn't find anything that could beet it for the longest time.
                        </p>    
                    </div>
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            <ul class="fa-ul">
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Carrots - 4 medium </span> <span class="badge">244g</span></li>
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Cucumber - 1/2 cucumber (8-1/4") </span> <span class="badge">150.5g</span></li>

                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Ginger Root - 1/2 thumb (1" dia) </span> <span class="badge">12g</span></li>
                    ...
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            ...
                            <b>Stomach Cancer Prevention</b><br>
