            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index20.php">    <i class="fa fa-angle-right"></i><em>   Day 20: Beet Nik          </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/Beet Nik.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 20: Beet Nik (30<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                ...
                <div class="container">
                    <div class="one-half-responsive">
                        ...
                        <p>
                            This is my first day of juicing and was surprised how much I enjoyed this. However, while I love celery to munch on, I found I don't really like the taste in this. Next time I'll try half of one stalk and go from there. Love all the ideas from everyone!
                        </p>    
                    </div>
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            <ul class="fa-ul">
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Beet Root - 1 beet (3" dia) </span> <span class="badge">175g</span></li>
                            
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Carrots - 8 medium </span> <span class="badge">488g</span></li>

                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Celery - 2 stalk, large (11"-12" long) </span> <span class="badge">128g</span></li>
                            
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Spinach - 3 cup </span> <span class="badge">90g</span></li>
                    ...
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            ...
                            <b>Macular Degeneration Prevention</b><br>
                            ...
                            <b>Heart Disease Prevention</b><br>
