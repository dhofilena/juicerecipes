            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index21.php">    <i class="fa fa-angle-right"></i><em>   Day 21: Rainbow Blitz          </em><i class="fa fa-circle"></i></a> 
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/Rainbow Blitz.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 21: Rainbow Blitz (30<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                ...
                <div class="container">
                    <div class="one-half-responsive">
                        ...
                        <p>
                            This one is pretty good, it doesn't look pretty though. I did add an extra apple and cut the ginger in half.
                        </p>    
                    </div>
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            <ul class="fa-ul">
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Carrots - 5 medium </span> <span class="badge">305g</span></li>
                            
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Cucumber - 1 cucumber (8-1/4") </span> <span class="badge">301g</span></li>
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Lemon - 1 fruit (2-1/8&quot; dia) </span> <span class="badge">58g</span></li>

                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Pear - 1 medium </span> <span class="badge">178g</span></li>

                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Spinach - 2 handful </span> <span class="badge">50g</span></li>
                    ...
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            ...
                            <b>Osteoporosis Prevention</b><br>
