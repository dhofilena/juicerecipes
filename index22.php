            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index22.php">    <i class="fa fa-angle-right"></i><em>   Day 22: Beginner Green          </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/Beginner Green.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 22: Beginner Green (30<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                        Probably the most delicious thing I've accidentally made.
                    </p>
                </div>
                    ...
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            <ul class="fa-ul">
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Apples - 3 medium (3" dia) </span> <span class="badge">546g</span></li>
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Ginger Root - 1/4 thumb (1" dia) </span> <span class="badge">6g</span></li>
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Orange (peeled) - 1 large (3-1/16" dia) </span> <span class="badge">184g</span></li>

                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Spinach - 5 handful </span> <span class="badge">125g</span></li>
