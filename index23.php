            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index23.php">    <i class="fa fa-angle-right"></i><em>   Day 23: Mean Green          </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/Mean Green.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 23: Mean Green (30<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                        This is Joe Cross' Fat Sick & Nearly Dead recipe called Mean Green.
                        <br><br>
                        Granny smiths are recommended, but you can use your favorite apples.
                    </p>
                </div>
                ...
                <div class="container">
                    <div class="one-half-responsive">
                        ...
                        <p>
                            It is very strong. Has a bite. Not very flavorful. Tastes like straight veggies. Or like a spice garden.
                        </p>    
                    </div>
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            <ul class="fa-ul">
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Kale - 6 leaf (8-12") </span> <span class="badge">210g</span></li>
