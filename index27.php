            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index27.php">    <i class="fa fa-angle-right"></i><em>   Day 27: Green Ginger Ale          </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/Green Ginger Ale.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 27: Green Ginger Ale (28<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                ...
                <div class="container">
                    <div class="one-half-responsive">
                        ...
                        <p>
                            This has become literally my favorite drink on this website. I actually can't get enough of it. I'm really shocked to see any bad reviews here but I suppose if you don't like tartness or ginger I wouldn't go for it. Also I never peel my limes/lemons!
                        </p>    
                    </div>
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            <ul class="fa-ul">
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Lime - 1 fruit (2" dia) </span> <span class="badge">67g</span></li>
