            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index29.php">    <i class="fa fa-angle-right"></i><em>   Day 29: Creamsicle          </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/Creamsicle.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 29: Creamsicle (30<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                        This juice takes a bit to grow on you. Taste very sweet and earthy from the sweet potato.
                    </p>
                </div>
                ...
                <div class="container">
                    <div class="one-half-responsive">
                        ...
                        <p>
                            This juice is creamy--it's dreamy, and it's everything you love about an orange creamsicle. Trust us, you're going to fall in love with this one! Freeze this juice recipe into popsicle molds for a guilt-free frozen treat!
                        </p>    
                    </div>
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            <ul class="fa-ul">
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Orange (peeled) - 1 fruit (2-5/8" dia) </span> <span class="badge">131g</span></li>
                                
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Pears - 2 medium </span> <span class="badge">356g</span></li>

                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Sweet Potato - 1 sweetpotato, 5" long </span> <span class="badge">130g</span></li>
