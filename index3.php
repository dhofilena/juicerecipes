            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index3.php">     <i class="fa fa-angle-right"></i><em>   Day 3: The Eye Opener          </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/The Eye Opener.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 3: The Eye Opener (30<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                        Yep, 14 carrots for today's recipe. It's not a typo. There's nothing wrong with that.
                    </p>
                </div>
                ...
                <div class="container">
                    <div class="one-half-responsive">
                        ...
                        <p>
                            This is really tasty, a good one to start the day and for the rest of the day as well. Make a double batch cause the old woman likes it also. I weigh out the ingredients cause the 14 carrots that I have are WAY over 854g.
                        </p>    
                    </div>
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            <ul class="fa-ul">
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Carrots - 14 medium </span> <span class="badge">854g</span></li>
                            
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Oranges (peeled) - 2 small (2-3/8" dia) </span> <span class="badge">192g</span></li>
