            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index30.php">    <i class="fa fa-angle-right"></i><em>   Day 30: Mexican-Style Jugo          </em><i class="fa fa-circle"></i></a>
                    </div>
                </div>                                 
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/Mexican-Style Jugo.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 30: Mexican-Style Jugo (40<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                ...
                <div class="container">
                    <div class="one-half-responsive">
                        ...
                        <p>
                            A perfect way to consume green peppers which I don't like too much.<br><br>
                            My last day of the challenge but by no means my last day of juicing.
                        </p>    
                    </div>
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            <ul class="fa-ul">
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Bell Pepper (green) (seeds removed) - 1/2 medium (approx 2-3/4" long, 2-1/2" dia) </span> <span class="badge">59.5g</span></li>
                            
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Cilantro - 1 bunch </span> <span class="badge">92g</span></li>
                                
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Cucumbers - 2 cucumber (8-1/4") </span> <span class="badge">602g</span></li>

                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Lime (with rind) - 1/2 fruit (2" dia) </span> <span class="badge">33.5g</span></li>
