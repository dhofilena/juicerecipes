            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index4.php">     <i class="fa fa-angle-right"></i><em>   Day 4: Fresh Start          </em><i class="fa fa-circle"></i></a>                        
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 4: Fresh Start (28<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
