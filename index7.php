            ...
            <div class="sidebar-menu">
                <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        ...
                        <a class="submenu-item submenu-item-active" href="index7.php">     <i class="fa fa-angle-right"></i><em>   Day 7: Lemon Ginger Zinger          </em><i class="fa fa-circle"></i></a>
        ...
        <div id="content" class="snap-content">
            <div class="content">
                ...
                <div class="homepage-slider container-fullscreen no-bottom">
                    <img src="img/Lemon Ginger Zinger.jpg" alt="img" height="100%" width="100%">
                </div>  
                
                <div class="decoration container-fullscreen"></div>

                <div class="slider-heading">
                    <h4 class="center-text uppercase">Day 7: Lemon Ginger Zinger (16<span style="text-transform: lowercase;">oz</span>) <br></h4>
                    <p class="center-text">
                        This recipe makes ~16oz, but you have enough produce to make this twice. Keep it for yourself or share it!
                    </p>
                </div>
                ...
                <div class="container">
                    <div class="one-half-responsive">
                        ...
                        <p>
                            This is so delicious! I was a little wary of the ginger, but it turned out so good! I also doubled it and will definitely be making this one again! This was my first homemade juice and what a great way to start.
                        </p>    
                    </div>
                    <div class="one-half-responsive last-column">
                        ...
                        <p>
                            <ul class="fa-ul">
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Carrots - 2 medium </span> <span class="badge">122g</span></li>
                                ...
                                <li style="padding-bottom:10px;"><i class="fa-li fa fa-xs fa-circle" style="color:#98ba75;"></i><span itemprop="ingredients">Lemon (with rind) - 1/2 fruit (2-1/8&quot; dia) </span> <span class="badge">29g</span></li>
